        ...
        <div className="mt-12">
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="mt-6">
                        ...
                        <span className="text-gray-500/70">(inclusion de toutes les taxes)</span>
                    </div>

                    <p className="text-base font-medium mt-6">A propos du produit</p>
            ...
            <div className="flex flex-col items-center mt-20">
                <div className="flex flex-col items-center w-max">
                    <p className="text-3xl font-medium">Produits similaire</p>
