    ...
    return (
        <section className="mx-4 md:mx-16 lg:mx-32 mt-32 mb-20">
            ...
            <div className="text-center mb-16 relative">
                ...
                >
                    <TrendingUp size={14} /> Marché d'ajourd'hui
                </motion.div>
            ...
            >
                <button
                    ...
                    className="group relative px-10 py-4 from-[#6FD3C1] to-pink-600 text-blue-500 rounded-full font-bold shadow-2xl shadow-gray-400/50 hover:shadow-gray-400/80 hover:-translate-y-1 transition-all duration-300 flex items-center gap-3 overflow-hidden"
                >
                    <span className="relative z-10 flex items-center gap-2">
                        Explorer toute la collection <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform"/>
                    </span>
                    {/* Hover Shine Effect */}
